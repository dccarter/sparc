...
#define KORE_TIMER_INPLACE    0x02
...
struct kore_timer    *kore_timer_add(void (*cb)(void *, u_int64_t),
                u_int64_t, void *, int);
void   kore_timer_set(struct kore_timer*);
struct kore_timer    *kore_timer_new(void (*cb)(void *, u_int64_t), u_int64_t interval,
               void *arg, int flags);
...
char        *kore_strndup(const char *, const size_t);
void        kore_log(int, const char *, ...);
void        kore_dump_trace(void);
void        kore_logs(int, const char *);
...
char *      kore_buf_reserve(struct kore_buf *, size_t);
...
void kore_color_vprintf(int, const char*, va_list);
void kore_color_printf(int, const char*, ...);
